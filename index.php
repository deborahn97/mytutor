    ...
    <div>
        ...
        <div id="login" class="w3-modal">
            <div class="w3-modal-content w3-card-4 w3-animate-zoom">
                ...
                <form name="user_login" action="" method="post" enctype="multipart/form-data">
                    <div class="w3-container w3-center w3-padding">
                        ...
                        <div class="w3-row w3-padding" style="display: flex; align-items: center; justify-content: center">
                            ...
                            <span style="margin: 0 15px"></span>
                            <div class="w3-col s5 m6 l7">
                                <input class="w3-input w3-border w3-round" name="password" type="password" placeholder="Password" required />
                            </div>
                        </div>
                        <div class="w3-padding-32">
